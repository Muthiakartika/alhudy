    ...
    <!-- Record DataTales Example -->
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo e(route('guru.update', $guru->id)); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                        id="namaGuru" name="nama" placeholder="Nama Guru" value="<?php echo e($guru->nama); ?>">
...
unset($__errorArgs, $__bag); ?>"
                        id="jabatan" name="jabatan" placeholder="Jabatan" value="<?php echo e($guru->nama); ?>">
...
unset($__errorArgs, $__bag); ?>"
                        id="tempat" name="tempat" placeholder="Tempat Lahir" value="<?php echo e($guru->tempat); ?>">
...
unset($__errorArgs, $__bag); ?>"
                        id="tglLahir" name="tglLahir" placeholder="Tanggal Lahir" value="<?php echo e($guru->tglLahir); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control <?php $__errorArgs = ['nipy'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        id="niyp" name="nipy" placeholder="NIPY" value="<?php echo e($guru->nipy); ?>">
...
unset($__errorArgs, $__bag); ?>"
                        id="noHp" name="noHp" placeholder="No Handphone" value="<?php echo e($guru->noHp); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webalhudy\resources\views/guru/edit.blade.php ENDPATH**/ ?>